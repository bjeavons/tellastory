...
async function gameplay(payload) {
    ...
    if (!game) {
        ...
        if (command.help) {
            response.body = twilio.twiml("Text an access keyword to join a story in progress or start one. All commands start with slash (/). Text /stop to leave or end a game. Msg&data rates may apply.");
        }
            ...
            response.body = twilio.twiml("Yay! Waiting for at least one more to join the game upon which you can start it by texting /start (with slash). Text /help for help or /stop to end the game. Msg&data rates may apply.");
        }
            ...
            if (storytime.hasStarted(game)) {
                ...
                response.body = twilio.twiml("You've joined an in progress game! Text /help (with slash) for help or /stop to leave at any time. Msg&data rates may apply.");
            }
            else {
                ...
                response.body = twilio.twiml("You've joined a pending game. The game creator will start it once ready! Text /help (with slash) for help or /stop to leave the game. Msg&data rates may apply.");
            }
        ...
        if (command.help) {
            response.body = twilio.twiml("All commands start with slash (/). Text /start to start a pending game you created. Text /stop to leave an in progress game or to end one you created. Msg&data rates may apply.");
        }
